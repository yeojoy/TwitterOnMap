...
class TwitterActivityController() {
    ...
    fun loginTwitter(twitterLoginView: TwitterLoginView) {
        ...
        val basicValue = "Basic ${Base64.encodeToString(sourceText.toByteArray(Charsets.UTF_8), Base64.NO_WRAP)}"
        ...
        val loginRequest =
            object : StringRequest(Method.POST, url, Response.Listener<String> { response ->
                ...
                override fun getHeaders(): MutableMap<String, String> {
                    ...
                    headers.put("Content-Type", "application/x-www-form-urlencoded;chaset=UTF-8")
                    return headers
                }
            }
